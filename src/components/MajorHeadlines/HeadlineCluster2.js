...
const HeadlineCluster2 = ({ mTitle, mDate, navigate, id, getBigArt }) => {
    ...
    const navigateToTopStory = () => navigate.navigate('Top Story', {topTitle: mTitle, topInfo: getBigArt(mTitle, id)})
